...
dbutils.widgets.text("source_system", "pracsqldb", "2 - source_system")
...
dbutils.widgets.text("target_hive_database", "brz_ghq_tech_pracsqldb", "5 - target_hive_database")
target_hive_database = dbutils.widgets.get("target_hive_database")
print(f"target_hive_database: {target_hive_database}")

dbutils.widgets.text("target_hive_table", "StockIndex", "6 - target_hive_table")
...
common_utils.configure_spn_access_for_adls(
    spark=spark,
    dbutils=dbutils,
    storage_account_names=[adls_raw_bronze_storage_account_name_wiz],
    key_vault_name=key_vault_name_wiz,
    spn_client_id=spn_client_id_wiz,
    spn_secret_name=spn_secret_name_wiz,
)

# COMMAND ----------

source_location = lakehouse_raw_root_wiz + raw_base_path
...
location = lakehouse_utils.generate_bronze_table_location(
    dbutils=dbutils,
    lakehouse_bronze_root=lakehouse_bronze_root_wiz,
